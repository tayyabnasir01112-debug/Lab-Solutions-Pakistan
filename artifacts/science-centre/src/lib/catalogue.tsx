...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "serological",
    featured: true,
    subtitle: "Rapid SARS-CoV-2 Antigen Detection — CE-IVD, Health Canada, ANVISA",
    description: "SGTi-flex COVID-19 Ag is a one-step immunoassay rapid test for qualitative detection of the SARS-CoV-2 nucleocapsid protein antigen directly from nasopharyngeal or nasal swab specimens. Results are visible to the naked eye within 15 minutes — no analyzer required. The test carries CE-IVD certification, Health Canada clearance, KMFDS (Korea) approval, and Brazilian ANVISA authorisation, making it one of the most widely cleared COVID-19 antigen tests available.",
    featureCards: [
      { title: "4-Market Regulatory Clearance", body: "CE-IVD (Europe), KMFDS (Korea), Health Canada IO (Canada), and ANVISA (Brazil) — SGTi-flex COVID-19 Ag is one of the most broadly cleared SARS-CoV-2 rapid antigen tests available, enabling supply across multiple regulated markets." },
      { title: "Nasopharyngeal or Nasal Swab", body: "Compatible with both nasopharyngeal (NP) and anterior nasal swab specimens — providing flexibility for healthcare professionals and enabling less invasive collection in community testing programmes." },
      { title: "15-Minute Visual Result", body: "Results readable with the naked eye in 15 minutes — no analyzer, no electricity, no laboratory infrastructure required. Ideal for emergency departments, clinics, field settings, and community health programmes." },
      { title: "Professional & Self-Test Formats", body: "Available in professional-use boxes of 25 (NP/nasal swab) and self-test format (individually boxed tests of 5 with nasal swab) — supporting both healthcare facility testing and at-home testing programmes." },
    ],
    features: [
      "Target: SARS-CoV-2 nucleocapsid protein antigen",
      "Method: Gold nanoparticle lateral flow immunoassay",
      "Sample: Nasopharyngeal swab or nasal swab",
      "Sample volume: 3 drops of extraction buffer",
      "Result time: 15 minutes (read within 30 min)",
      "Storage: 2–30°C",
      "Shelf life: 24 months",
      "Formats: Professional (25 tests/box) + Self-test (5 tests/box)",
      "Regulatory: CE-IVD, KMFDS, Health Canada IO, ANVISA",
    ],
    applications: [
      "Rapid SARS-CoV-2 diagnosis in symptomatic patients",
      "Emergency department and clinical triage",
      "Community and workplace screening programmes",
      "Travel and quarantine facility testing",
      "At-home self-testing (self-test format)",
    ],
    specs: {
      "Target Antigen": "SARS-CoV-2 nucleocapsid protein",
      "Sample Types": "Nasopharyngeal swab, nasal swab",
      "Sample Volume": "3 drops (extraction buffer/sample mixture)",
      "Result Time": "15 minutes",
      "Result Reading Window": "Read within 30 minutes",
      "Storage Temperature": "2–30°C (36–86°F)",
      "Shelf Life": "24 months",
      "Packaging": "Professional: 25 tests/box | Self-test: 5 tests/box",
      "Regulatory": "CE-IVD, KMFDS, Health Canada IO, ANVISA",
    },
    kits: [
      { name: "SGTi-flex COVID-19 Ag — Professional (25 tests)", description: "Box of 25 individually wrapped cassettes with nasopharyngeal/nasal swabs and extraction buffer. CE-IVD, KMFDS, Health Canada IO, ANVISA.", catalogueNumber: "COV-AG-PRO-25" },
      { name: "SGTi-flex COVID-19 Ag — Self-Test (5 tests)", description: "Five individually boxed nasal swab self-tests for at-home use. CE-IVD self-test certified. Includes step-by-step illustrated instructions.", catalogueNumber: "COV-AG-SELF-5" },
      { name: "COVID-19 Ag Extraction Buffer", description: "Additional extraction buffer tubes for high-volume testing sites. Compatible with all SGTi-flex COVID-19 Ag cassette formats." },
    ],
    tags: ["COVID-19", "antigen", "rapid test", "SARS-CoV-2", "CE-IVD", "lateral flow"],
    relatedProducts: ["sug-covid-flu", "sug-covid-igg", "sug-inclix"],
  },
  {
    id: "sug-covid-flu",
    name: "SGTi-flex COVID-19 & Flu A/B Ag",
    brand: "sugentech",
    category: "serological",
    subtitle: "Simultaneous SARS-CoV-2 + Influenza A & B Antigen Detection",
    description: "SGTi-flex COVID-19 & Flu A/B Ag is a multiplex rapid antigen test for simultaneous qualitative detection of SARS-CoV-2, Influenza A, and Influenza B antigens from a single nasopharyngeal swab specimen. A single cassette and one patient sample differentiates three pathogens that present with identical respiratory symptoms — enabling targeted treatment decisions without running three separate tests.",
    featureCards: [
      { title: "3 Pathogens, 1 Test, 1 Swab", body: "Simultaneously detects SARS-CoV-2, Influenza A, and Influenza B from a single nasopharyngeal swab. Three distinct test lines give unambiguous results for all three pathogens simultaneously in a single 15-minute cassette." },
      { title: "Clinically Critical Differentiation", body: "COVID-19, Influenza A, and Influenza B share identical presenting symptoms. Accurate differentiation directly determines antiviral therapy selection — Tamiflu or Xofluza for influenza vs. antivirals for COVID — improving outcomes and reducing unnecessary treatment." },
      { title: "CE-IVD + KMFDS Certified", body: "Dual regulatory certification for Europe (CE-IVD) and Korea (KMFDS) — qualifying SGTi-flex COVID-19 & Flu A/B Ag for routine diagnostic use in hospital emergency departments, outpatient clinics, and community health facilities." },
      { title: "For Healthcare Professionals", body: "Designed for trained laboratory personnel and healthcare professionals. Includes nasopharyngeal swabs, extraction buffer, and positive/negative controls for influenza A, influenza B, and SARS-CoV-2 within each kit." },
    ],
    features: [
      "Targets: SARS-CoV-2, Influenza A, Influenza B (simultaneous multiplex)",
      "Sample: Nasopharyngeal swab",
      "Sample volume: 3 drops",
      "Result time: 15 minutes",
      "Method: Lateral flow immunoassay",
      "Storage: 2–30°C",
      "Kit includes: Positive and negative controls for all three targets",
      "Regulatory: CE-IVD, KMFDS",
      "Use: Healthcare professional / laboratory professional",
    ],
    applications: [
      "Respiratory triage in emergency departments",
      "Influenza vs. COVID-19 differential diagnosis",
      "Outpatient clinic rapid syndromic testing",
      "Seasonal respiratory illness surveillance",
      "Infection control screening in hospitals",
    ],
    specs: {
      "Targets Detected": "SARS-CoV-2, Influenza A, Influenza B",
      ...
      "Sample Volume": "3 drops",
      "Result Time": "15 minutes",
      "Controls Included": "Positive and negative controls (all 3 targets)",
      "Storage": "2–30°C (36–86°F)",
      "Regulatory": "CE-IVD, KMFDS",
      "Intended User": "Healthcare / laboratory professional",
    },
    kits: [
      { name: "SGTi-flex COVID-19 & Flu A/B Ag — Professional Kit", description: "Cassettes detecting SARS-CoV-2, Influenza A, and Influenza B simultaneously. Includes nasopharyngeal swabs, extraction buffer, and positive/negative controls for all three targets. CE-IVD, KMFDS.", catalogueNumber: "COV-FLU-PRO-25" },
      { name: "Flu A/B Positive Control Swabs", description: "Validated positive control swabs for Influenza A and Influenza B targets — for quality assurance and staff training in multiplexed antigen testing." },
      { name: "Extraction Buffer (COVID+Flu)", description: "Extraction buffer formulated for the SGTi-flex multiplex cassette. Compatible with nasopharyngeal swab specimens only." },
    ],
    tags: ["COVID-19", "influenza", "multiplex", "rapid test", "CE-IVD", "respiratory"],
    relatedProducts: ["sug-covid-ag", "sug-covid-igg", "sug-inclix"],
  },
  {
    id: "sug-covid-igg",
    name: "SGTi-flex COVID-19 IgM/IgG",
    brand: "sugentech",
    category: "serological",
    subtitle: "Rapid Antibody Test — IgM & IgG to SARS-CoV-2",
    description: "SGTi-flex COVID-19 IgM/IgG is a gold nanoparticle-based lateral flow immunoassay for simultaneous qualitative detection of IgM and IgG antibodies to SARS-CoV-2 in whole blood (finger prick or venous), serum, or plasma. Results are visible within 10 minutes without any analyzer — providing immediate seroprevalence screening and immune status information at the point of care.",
    features: [
      "Targets: Anti-SARS-CoV-2 IgM + IgG antibodies (simultaneous)",
      "Sample: Whole blood (finger prick/venous), serum, plasma",
      "Method: Gold nanoparticle lateral flow",
      "Result time: 10 minutes (read within 30 min)",
      "No analyzer required",
      "Package: 5 individually wrapped cassettes + sample buffer tube",
      "Regulatory: CE-IVD, KMFDS",
      "US FDA EUA authorised (IgG version)",
    ],
    applications: [
      "SARS-CoV-2 seroprevalence screening",
      "Post-infection immune status assessment",
      "Vaccination response monitoring (IgG)",
      "Epidemiological studies and population surveys",
    ],
    specs: {
      "Targets": "IgM and IgG antibodies to SARS-CoV-2",
      "Sample Types": "Whole blood, serum, plasma",
      "Sample Source": "Finger prick or venous blood",
      "Result Time": "10 minutes",
      "Reading Window": "Within 30 minutes",
      "Packaging": "5 individually wrapped cassettes + sample buffer tube",
      "Regulatory": "CE-IVD, KMFDS, US FDA EUA (IgG)",
    },
    kits: [
      { name: "SGTi-flex COVID-19 IgM/IgG Kit (5 tests)", description: "Five individually wrapped cassettes with sample buffer tube. For simultaneous qualitative IgM and IgG detection from whole blood, serum, or plasma. CE-IVD, KMFDS, FDA EUA (IgG).", catalogueNumber: "COVC0001E" },
      { name: "SGT Anti-SARS-CoV-2 Total Ab ELISA", description: "Enzyme-linked immunosorbent assay for quantitative measurement of total antibodies (IgG + IgM + IgA) to SARS-CoV-2 — for detailed serological studies in clinical or research laboratory settings." },
      { name: "SGT SARS-CoV-2 In Vitro Neutralising Antibody Test (IVnAT)", description: "Rapid lateral flow test to detect neutralising antibodies against SARS-CoV-2 — assessing functional immune protection post-infection or post-vaccination without a BSL-3 laboratory." },
    ],
    tags: ["COVID-19", "antibody", "IgG", "IgM", "serology", "lateral flow", "CE-IVD"],
    relatedProducts: ["sug-covid-ag", "sug-covid-flu", "sug-inclix"],
  },
  {
    id: "sug-allergy",
