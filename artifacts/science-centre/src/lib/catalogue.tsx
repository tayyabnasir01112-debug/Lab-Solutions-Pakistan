...
export const products: Product[] = [
  ...
  /* ── INESA-REX ─────────────────────────────────────────────── */
  {
    ...
    category: "ph-meters",
    featured: true,
    subtitle: "Professional Benchtop Multi-Parameter Analyzer — pH, EC, DO, Ion & More",
    description: "The M600L is REX's flagship benchtop multi-parameter analyzer, measuring up to 8 electrochemical parameters simultaneously from a single instrument — pH, mV, ORP, ISE ion concentration, EC, TDS, salinity, resistivity, DO, and temperature. With its modular slot design, 7-inch colour LCD touch screen, GLP-compliant data logging, and USB connectivity, it is purpose-built for demanding laboratory environments in water treatment, food & beverage, pharmaceutical, and research settings.",
    ...
    featureCards: [
      { title: "8 Parameters, 1 Instrument", body: "Simultaneously measures pH, mV, ORP, ISE ion concentration, conductivity (EC), TDS, salinity, resistivity, dissolved oxygen (DO), and temperature — reducing bench space and cost versus multiple dedicated instruments." },
      { title: "Modular Slot Design", body: "Unique professional-moldable configuration with interchangeable input modules — configure the M600L with the exact parameter combination your laboratory needs, then upgrade or reconfigure as requirements change." },
      { title: "7-Inch Colour Touch Screen", body: "Large, high-contrast colour LCD touch screen displays real-time readings, calibration curves, and trend graphs simultaneously — intuitive to operate without training, even for non-specialist users." },
      { title: "GLP Data Management", body: "Stores up to 2,000 data sets with date, time, operator ID, and calibration status. Exports to PC via USB for GLP-compliant record-keeping in regulated laboratory environments." },
      { title: "Auto-Calibration & ATC", body: "Automatic temperature compensation (ATC) corrects readings across the full measuring range. Multi-point automatic calibration using standard buffers and solutions — minimises operator error." },
      { title: "China's Analytical Pioneer", body: "Designed and manufactured by INESA-REX — founded in 1940 and China's first electrochemical instrument manufacturer. Over 80 years of analytical instrument expertise behind every measurement." },
    ],
    features: [
      "Parameters: pH, mV, ORP, ISE, EC, TDS, salinity, resistivity, DO, temperature",
      "Display: 7-inch colour LCD touch screen",
      "Input channels: Up to 8 (modular configuration)",
      "Data storage: 2,000 data sets with GLP timestamp",
      "Connectivity: USB (PC data transfer)",
      "Calibration: Multi-point auto-calibration with ATC",
      "Power: AC adapter",
      "Weight: ~2.5 kg benchtop",
    ],
    applications: [
      "Water quality monitoring — municipal water, wastewater, drinking water",
      "Pharmaceutical QC — pH of process solutions and API buffers",
      "Food & beverage production — acidity, ion content, DO monitoring",
      "Environmental monitoring — soil and water analysis",
      "Research laboratory — multi-parameter electrochemical studies",
      "Industrial process control — conductivity and DO monitoring",
    ],
    specs: {
      "Parameters": "pH, mV, ORP, ISE, EC, TDS, Salinity, Resistivity, DO, Temperature",
      "pH Range": "−2.000 to 19.999 pH",
      "pH Accuracy": "±0.001 pH",
      "EC Range": "0 to 200 S/m",
      "DO Range": "0 to 20.00 mg/L",
      "Display": "7-inch colour LCD touch screen",
      "Data Storage": "2,000 datasets (GLP)",
      "Connectivity": "USB",
      "Calibration": "Multi-point automatic with ATC",
      "Power": "100–240 V AC, 50/60 Hz",
    },
    tags: ["pH meter", "multi-parameter", "benchtop", "EC", "DO", "electrochemical", "GLP"],
    relatedProducts: ["rex-ph500t", "rex-ti51", "rex-m510t"],
  },
  {
    id: "rex-ph500t",
    ...
    category: "ph-meters",
    featured: true,
    subtitle: "Professional Smart Benchtop pH Meter — 500T Series",
    description: "The PH500T is REX's professional-grade benchtop pH meter combining precision electrochemical measurement with a smart, intuitive interface. Measuring pH, mV, ORP, ISE ion concentration, and temperature with ±0.001 pH accuracy, the PH500T features a colour touch screen, automatic multi-point calibration, GLP data logging, and USB connectivity — ideal for QC laboratories, pharmaceutical production, and environmental analysis.",
    ...
    featureCards: [
      { title: "±0.001 pH Precision", body: "Laboratory-grade ±0.001 pH accuracy with a −2.000 to 19.999 pH range. Exceeds requirements for pharmaceutical, food & beverage, and environmental monitoring applications." },
      { title: "Smart Auto-Calibration", body: "Automatic 1 to 5-point calibration using standard pH buffer sets. Automatically identifies buffer solutions, calculates electrode slope, and alerts when calibration is expired or electrode performance degrades." },
      { title: "Colour Touch Screen Interface", body: "High-contrast colour display shows pH, temperature, electrode slope, calibration status, and stability indicator simultaneously. Guided menus require no instruction manual for routine operation." },
      { title: "Complete Electrochemical Suite", body: "Beyond pH, measures mV, ORP (redox potential), and ISE ion concentration — making the PH500T a versatile benchtop instrument for any wet chemistry workflow." },
    ],
    features: [
      "Measurements: pH, mV, ORP, ISE, Temperature",
      "pH range: −2.000 to 19.999 pH",
      "pH accuracy: ±0.001 pH",
      "Calibration: 1 to 5-point automatic",
      "Display: Colour touch screen",
      "ATC: Automatic temperature compensation",
      "Data storage: GLP-compliant with USB export",
      "Series: 500T (Professional-Smart)",
    ],
    applications: [
      "QC laboratory routine pH measurement",
      "Pharmaceutical buffer and API pH testing",
      "Food & beverage acidity control",
    ...
    tags: ["pH meter", "benchtop", "ORP", "ISE", "pharmaceutical", "GLP"],
    relatedProducts: ["rex-m600l", "rex-ph510t", "rex-electrodes"],
  },
  {
    id: "rex-ph510t",
    ...
    subtitle: "Professional Smart Portable pH Meter — Field & Outdoor Use",
    description: "The PH510T is REX's professional portable pH meter for field and on-site electrochemical measurement. Measuring pH, mV, ORP, ISE ion concentration, and temperature with laboratory-grade ±0.01 pH accuracy, it combines IP67-rated weatherproofing, internal rechargeable battery, and a large backlit display — delivering reliable measurements in water treatment plants, field environmental surveys, agricultural settings, and industrial process environments.",
    image: "https://omo-oss-image1.thefastimg.com/portal-saas/pg2024031317245957733/cms/image/cfbd9196-2f58-4676-8391-cac2429ca53e.jpg",
    features: [
      "Measurements: pH, mV, ORP, ISE, Temperature",
      "pH range: −2.000 to 19.999 pH",
      ...
      "Backlit display for low-light field use",
      "Auto-calibration: 1 to 3-point",
      "Series: 510T (Portable-Professional-Smart)",
    ],
    applications: [
      "On-site water quality testing",
      "Field environmental pH monitoring",
      "Agricultural soil and irrigation water analysis",
      "Industrial wastewater pH monitoring",
      "Swimming pool and aquaculture management",
    ],
    specs: {
      "pH Range": "−2.000 to 19.999 pH",
      "pH Accuracy": "±0.01 pH",
      ...
      "Display": "Backlit LCD",
      "Series": "510T Portable",
    },
    tags: ["portable", "pH meter", "field", "IP67", "ORP", "waterproof"],
    relatedProducts: ["rex-ph500t", "rex-m510t", "rex-electrodes"],
  },
  {
    id: "rex-m510t",
    ...
    brand: "rex",
    category: "portable-meters",
    subtitle: "Professional Smart Portable Multi-Parameter Analyzer",
    description: "The M510T is REX's portable multi-parameter field analyzer, simultaneously measuring pH, mV, ORP, ion concentration, conductivity (EC), TDS, dissolved oxygen (DO), and temperature from a single handheld instrument. With IP67 weatherproofing and a rechargeable battery, it delivers benchtop-class measurements in the field — ideal for environmental monitoring, water treatment, and aquaculture.",
    image: "https://omo-oss-image1.thefastimg.com/portal-saas/pg2024031317245957733/cms/image/7b354f6b-4dd9-457a-8632-75e60e59b2b0.jpg",
    features: [
      "Parameters: pH, mV, ORP, ISE, EC, TDS, Salinity, DO, Temperature",
      "IP67 waterproof and dust-proof",
      "Rechargeable Li-ion battery",
      "Simultaneous multi-parameter display",
      "Auto-calibration with ATC",
      "Series: 510T (Portable-Professional-Smart)",
    ],
    applications: [
      "Field water quality monitoring — rivers, lakes, groundwater",
      "Aquaculture — DO, pH, EC monitoring",
      "Environmental impact assessments",
      "Industrial wastewater monitoring",
      "Drinking water quality surveys",
    ],
    specs: {
      "Parameters": "pH, mV, ORP, ISE, EC, TDS, Salinity, DO, Temperature",
      "IP Rating": "IP67",
      "Battery": "Rechargeable Li-ion",
      "Series": "510T Portable Multi-Parameter",
    },
    tags: ["portable", "multi-parameter", "field", "DO", "EC", "IP67"],
    relatedProducts: ["rex-m600l", "rex-ph510t", "rex-electrodes"],
  },
  {
    id: "rex-ti51",
    ...
    description: "The Ti-51 is REX's flagship automatic titrator, supporting both potentiometric and photometric titration modes from a single instrument. With a 7-inch colour LCD touch screen, precision 20 mL burette (±0.002 mL accuracy), built-in thermal printer, USB/RS-232 connectivity, and storage for up to 30 methods, the Ti-51 delivers high-throughput, reproducible titrations for pharmaceutical QC, food & beverage, chemical manufacturing, and environmental analysis.",
    ...
    featureCards: [
      { title: "Potentiometric + Photometric", body: "The Ti-51 uniquely combines potentiometric titration (pH, mV endpoint detection) with photometric titration (colorimetric endpoint detection) in one instrument — covering both traditional and modern titration methods." },
      { title: "7-Inch Touch Screen", body: "Large colour LCD touch screen displays the real-time titration curve, endpoint detection, and calculated results simultaneously. Guided method selection makes routine titrations fast and error-free." },
      { title: "±0.002 mL Burette Accuracy", body: "High-precision 20 mL burette delivers ±0.002 mL volume accuracy — ensuring traceability and reproducibility for pharmaceutical and QC titrations where precision is critical." },
      { title: "30 Method Storage", body: "Store, name, and recall up to 30 complete titration methods including titrant concentration, endpoint criteria, equivalence point algorithm, and calculation formula — minimising setup time for repeat analyses." },
      { title: "Built-in Thermal Printer", body: "Integrated thermal printer produces a timestamped hardcopy of every titration — titration curve, endpoint, volume, and calculated result — for GLP-compliant paper records without a separate printer." },
      { title: "Acid–Base, Redox, Precipitation & Complexometric", body: "A single Ti-51 covers all four major titration types: acid–base, redox (iodometric, permanganate), precipitation (argentometric for chloride), and complexometric (EDTA for water hardness, heavy metals)." },
    ],
    features: [
      "Titration modes: Potentiometric + Photometric (dual)",
      "Burette volume: 20 mL",
      "Burette accuracy: ±0.002 mL",
      "Endpoint detection: Automatic (equivalence point algorithm)",
      "Method storage: 30 named methods",
      "Display: 7-inch colour LCD touch screen",
      "Printer: Built-in thermal printer",
      "Connectivity: USB + RS-232",
      "Titration types: Acid–base, redox, precipitation, complexometric",
    ],
    applications: [
      "Acid–base titration — acidity/alkalinity in water, food, pharma",
      "Redox titration — iodometric (vitamin C, bleach), KMnO₄",
      "Precipitation titration — chloride (argentometric), Mohr method",
      "Complexometric titration — water hardness (EDTA), heavy metals",
      "Photometric titration — coloured solution endpoints",
      "Pharmaceutical raw material and finished product QC",
      "Food & beverage — total acid, alcohol content, sugar",
    ],
    specs: {
      "Titration Modes": "Potentiometric + Photometric",
      "Burette Volume": "20 mL",
      "Volume Accuracy": "±0.002 mL",
      "Volume Resolution": "0.001 mL",
      "Endpoint Detection": "Automatic equivalence point (EP)",
      "Method Memory": "30 methods",
      "Display": "7-inch colour LCD touch screen",
      "Printer": "Built-in thermal printer",
      "Connectivity": "USB, RS-232",
      "Power": "100–240 V AC",
    },
    tags: ["titrator", "automatic", "potentiometric", "photometric", "pharmaceutical", "GLP"],
    relatedProducts: ["rex-kft50vc", "rex-m600l", "rex-ph500t"],
  },
  {
    id: "rex-kft50vc",
    ...
    description: "The KFT-50VC is REX's top-of-range Karl Fischer titrator, uniquely supporting both volumetric (KFV) and coulometric (KFC) Karl Fischer titration in a single switchable instrument. Covering a moisture detection range from 10 μg to 999.9 mg (coulometric) and 0.01% to 100% water content (volumetric), it measures moisture in pharmaceuticals, petrochemicals, food ingredients, polymers, and electronic components with exceptional accuracy and traceability.",
    image: "https://omo-oss-image1.thefastimg.com/portal-saas/pg2024031317245957733/cms/image/5cde3c27-71c8-4648-bb3d-5c0368a7876e.jpg",
    featureCards: [
      { title: "Volumetric + Coulometric in One", body: "Switch between volumetric Karl Fischer (for higher water content 0.01–100%) and coulometric Karl Fischer (for trace moisture 10 μg–999.9 mg) without a second instrument — covering the full practical moisture range." },
      { title: "Trace Moisture to Bulk Water", body: "Coulometric mode detects moisture down to 10 μg — critical for petrochemicals, polymers, and electronic components where even trace water causes product failure. Volumetric mode handles pharmaceuticals, food, and process chemicals." },
      { title: "GLP-Compliant Reporting", body: "Stores results with date, time, sample ID, method name, and moisture value. Exports to PC via USB for LIMS integration. Built-in thermal printer for immediate hardcopy — meeting GMP and GLP documentation requirements." },
      { title: "Integrated Coulometric Cell", body: "High-stability coulometric generator cell with platinum electrode array and dual-compartment design — ensuring accurate iodine generation without cross-contamination and consistent results across hundreds of samples." },
    ],
    features: [
      "Modes: Volumetric KF (KFV) + Coulometric KF (KFC) — switchable",
      "Coulometric range: 10 μg to 999.9 mg water",
      "Volumetric range: 0.01% to 100% water content",
      "Accuracy: ±0.5% (volumetric), ±1% (coulometric)",
      "Coulometric cell: Platinum electrode, dual-compartment",
      "Display: Touch screen",
      "Printer: Built-in thermal printer",
      "Connectivity: USB, RS-232",
      "Method storage: Multiple named methods",
    ],
    applications: [
      "Pharmaceutical — raw material and finished product moisture",
      "Petrochemical — water in oil, fuel, lubricants",
      "Food & beverage — moisture in solids, powders, oils",
      "Polymers and plastics — trace moisture content",
      "Electronic components — moisture in capacitors, resins",
      "Chemical manufacturing — reagent and solvent water content",
      "Battery materials — water in electrolytes and electrodes",
    ],
    specs: {
      "Titration Modes": "Volumetric KF (KFV) + Coulometric KF (KFC)",
      "Coulometric Range": "10 μg to 999.9 mg water",
      "Volumetric Range": "0.01% to 100% water content",
      "Coulometric Accuracy": "±1%",
      "Volumetric Accuracy": "±0.5%",
      "Coulometric Cell": "Platinum electrode, dual-compartment",
      "Display": "Touch screen with real-time titration curve",
      "Printer": "Built-in thermal printer",
      "Connectivity": "USB, RS-232",
    },
    tags: ["Karl Fischer", "moisture", "coulometric", "volumetric", "pharmaceutical", "petrochemical"],
    relatedProducts: ["rex-ti51", "rex-m600l"],
  },
  {
    id: "rex-tu4000s",
    ...
    category: "turbidity",
    featured: true,
    subtitle: "High-Performance Benchtop Turbidity Meter — Dual Light Source",
    description: "The TU4000S is REX's premium benchtop turbidity meter, using both an 860 nm near-infrared LED light source and a tungsten lamp to deliver high-accuracy turbidity measurements from 0 to 4000 NTU. With automatic range switching, multi-point calibration, large colour touch screen, and GLP data management, it meets ISO 7027 standards for water quality turbidity measurement in municipal water treatment, environmental laboratories, and pharmaceutical QA.",
    ...
    featureCards: [
      { title: "Dual Light Source — 860 nm LED + Tungsten", body: "The TU4000S uses both an 860 nm near-infrared LED (ISO 7027 compliant) and a tungsten lamp — automatically selecting the optimal light source based on the measurement range to achieve maximum linearity and sensitivity across 0–4000 NTU." },
      { title: "ISO 7027 Compliance", body: "Designed and calibrated to ISO 7027 (Water quality — Determination of turbidity) — the international standard for water turbidity measurement using 860 nm nephelometric methods. Results are directly comparable across laboratories worldwide." },
      { title: "0.001 NTU Resolution", body: "0.001 NTU resolution at the low end of the range enables precise measurement of drinking water clarity (WHO limit 1 NTU, EPA limit 0.3 NTU) and other high-purity water quality applications." },
      { title: "Auto Range & Auto Calibration", body: "Automatic range switching covers 0–4000 NTU without manual adjustment. Multi-point automatic calibration using AMCO AEPA-1 or formazin standards ensures traceability and accuracy across the full measurement range." },
    ],
    features: [
      "Light sources: 860 nm near-IR LED + Tungsten lamp (dual)",
      "Turbidity range: 0 to 4000 NTU",
      "Resolution: 0.001 NTU (low range)",
      "Accuracy: ±2% FS",
      "Standard compliance: ISO 7027",
      "Range switching: Automatic",
      "Calibration: Multi-point automatic",
      "Display: Colour touch screen",
      "Data storage: GLP-compliant",
      "Connectivity: USB, RS-232",
    ],
    applications: [
      "Municipal drinking water quality monitoring",
      "Wastewater treatment effluent measurement",
      "Environmental water quality analysis — rivers, lakes",
      "Pharmaceutical water for injection (WFI) turbidity",
      "Food & beverage — beer, juice, oil clarity",
      "Industrial process water monitoring",
    ],
    specs: {
      "Light Sources": "860 nm near-IR LED + Tungsten lamp",
      "Measurement Range": "0 to 4000 NTU",
      "Resolution": "0.001 NTU (low); 0.01 NTU (mid); 0.1 NTU (high)",
      "Accuracy": "±2% FS or ±0.02 NTU (whichever is greater)",
      "Standard": "ISO 7027",
      "Range Switching": "Automatic",
      "Display": "Colour touch screen",
      "Connectivity": "USB, RS-232",
    ...
    tags: ["turbidity", "NTU", "ISO 7027", "water quality", "benchtop", "drinking water"],
    relatedProducts: ["rex-tu2000p", "rex-m600l"],
  },
  {
    id: "rex-tu2000p",
    ...
    brand: "rex",
    category: "turbidity",
    subtitle: "Portable Turbidity Meter — 860 nm, 0–1000 NTU",
    description: "The TU2000P is REX's portable turbidity meter for on-site water quality measurement. Using a 860 nm LED light source with ISO 7027 compliance, it measures turbidity from 0 to 1000 NTU with 0.01 NTU resolution. Waterproof, battery-operated, and compact, the TU2000P is designed for field environmental surveys, drinking water testing, and wastewater monitoring.",
    image: "https://omo-oss-image1.thefastimg.com/portal-saas/pg2024031317245957733/cms/image/7b354f6b-4dd9-457a-8632-75e60e59b2b0.jpg",
    features: [
    ...
    applications: [
      ...
      "Drinking water spot checks",
      "Wastewater and effluent monitoring",
      "Environmental monitoring — rivers, wells",
    ],
    specs: {
      "Light Source": "860 nm near-IR LED",
      "Range": "0 to 1000 NTU",
    ...
    tags: ["turbidity", "portable", "NTU", "field", "water quality", "ISO 7027"],
    relatedProducts: ["rex-tu4000s", "rex-m510t"],
  },
  {
    id: "rex-electrodes",
    name: "REX pH & Electrochemical Electrodes",
    brand: "rex",
    category: "electrodes",
    subtitle: "Full Range of pH, EC, DO, ISE, ORP & Reference Electrodes",
    description: "REX manufactures a comprehensive range of electrochemical electrodes to complement their meter portfolio — from standard pH composite electrodes (E-301-QC, 3-in-1 with temperature sensor) to specialist electrodes for ultrapure water, strongly alkaline solutions, high-temperature applications, and ion-selective measurement. All electrodes are engineered to REX meter specifications for optimal performance and calibration accuracy.",
    featureCards: [
      { title: "pH Composite Electrodes", body: "REX's most popular electrodes combine the pH-sensitive glass membrane, Ag/AgCl reference, and temperature sensor in a single 3-in-1 body (E-301-QC) — reducing setup time and ensuring reliable pH measurement across 0–14 pH." },
      { title: "Specialist pH Electrodes", body: "Dedicated electrodes for ultrapure water (962221, 3–11 pH), strongly alkaline media (high-alkali glass), flat-surface applications (for food, skin, paper), and micro-volume measurements — covering specialist laboratory needs." },
      { title: "Conductivity (EC) Electrodes", body: "Stainless steel and graphite EC electrode cells with cell constants of K=0.1, 1, and 10 — covering ultra-pure water (sub-μS/cm), standard solutions, and high-conductivity industrial liquids." },
      { title: "Ion-Selective Electrodes (ISE)", body: "REX offers ISE probes for fluoride (F⁻), nitrate (NO₃⁻), calcium (Ca²⁺), potassium (K⁺), sodium (Na⁺), ammonium (NH₄⁺), and other ions — for direct potentiometric ion concentration measurement without wet chemistry." },
    ],
    features: [
      "Types: pH, EC, DO, ORP, ISE (ion-selective), reference, temperature",
      "pH electrodes: Standard, ultrapure water, alkaline, flat surface, micro",
      "EC cells: K=0.1, 1, 10 — full range",
      "ISE probes: F⁻, NO₃⁻, Ca²⁺, K⁺, Na⁺, NH₄⁺, Cl⁻, Pb²⁺, Cd²⁺, Cu²⁺",
      "Compatible: All REX 100B–600L series meters",
      "Connections: BNC + temperature jack (pH); DIN (EC/DO)",
    ],
    applications: [
      "Water quality — pH, conductivity, dissolved oxygen",
      "Pharmaceutical — pH of buffers, WFI conductivity",
      "Environmental — soil pH, water ion analysis",
      "Food & beverage — acidity, sodium, nitrate testing",
      "Industrial — process pH, ORP, conductivity monitoring",
    ],
    specs: {
      "pH Electrode Models": "E-301-QC, 962221 (ultrapure), E-201-C, flat-surface, micro",
      "pH Range": "0–14 pH (standard); 3–11 (ultrapure model)",
      "EC Cell Constants": "K=0.1, 1, 10",
      "ISE Ions": "F⁻, NO₃⁻, Ca²⁺, K⁺, Na⁺, NH₄⁺, Cl⁻, heavy metals",
      "Compatibility": "All REX 100B to 600L series",
      "Connections": "BNC / DIN",
    },
    tags: ["electrode", "pH electrode", "EC", "ISE", "DO", "ORP", "sensors"],
    relatedProducts: ["rex-ph500t", "rex-m600l", "rex-m510t"],
  },
  {
    id: "rex-hm101p",
    ...
    brand: "rex",
    category: "moisture",
    subtitle: "Precision Halogen Rapid Moisture Analyzer — 0.001 g Resolution",
    description: "The HM-101P is REX's halogen moisture analyzer, using a halogen infrared heater for fast, accurate thermogravimetric moisture determination. Simply place a sample on the integrated balance, start the measurement, and in minutes the HM-101P displays the moisture content as a percentage — without reagents, solvents, or Karl Fischer titration. Ideal for moisture content QC in food, pharmaceuticals, plastics, chemicals, and agricultural products.",
    image: "https://omo-oss-image1.thefastimg.com/portal-saas/pg2024031317245957733/cms/image/36954e50-3694-4e83-ba4f-a6911accb013.jpg",
    features: [
      ...
      "Display: Large LCD with result graphics",
      "Connectivity: USB, RS-232",
    ],
    applications: [
      "Food — moisture in grains, powders, spices, dairy",
      "Pharmaceutical — moisture in API, tablets, excipients",
      "Plastics & polymers — moisture before moulding",
      "Chemical — moisture in pigments, resins, salts",
      "Agricultural — grain and seed moisture content",
      "Paper & printing — paper moisture content",
    ],
    specs: {
      "Heating": "Halogen infrared lamp",
      "Moisture Range": "0 to 100%",
      "Balance Capacity": "120 g",
      "Balance Readability": "0.001 g",
      "Moisture Readability": "0.01%",
      "Temperature": "50 to 200 °C",
      "Display": "LCD with graphics",
      "Connectivity": "USB, RS-232",
    },
    tags: ["moisture analyzer", "halogen", "thermogravimetric", "food", "pharmaceutical", "rapid"],
    relatedProducts: ["rex-ti51", "rex-kft50vc", "rex-m600l"],
  },
  {
    id: "rex-cod200",
    name: "REX COD-200 COD Analyzer + Reactor",
    brand: "rex",
    category: "turbidity",
    subtitle: "Chemical Oxygen Demand Analyzer — Water Quality COD Testing",
    description: "The REX COD-200 system comprises the COD-200 colorimetric analyzer and COD-200R digestion reactor for complete Chemical Oxygen Demand (COD) determination of water samples. Using the standard dichromate closed reflux colorimetric method (ISO 6060 / GB 11914), the system digests samples at 165 °C in 30 minutes and measures COD from 5 to 3000 mg/L O₂ — covering drinking water, wastewater, and industrial effluent monitoring requirements.",
    features: [
      "Method: Dichromate closed reflux colorimetry (ISO 6060 / GB 11914)",
      "COD range: 5–3000 mg/L O₂",
      "Digestion: 165 °C, 30-minute closed reflux",
      "Reactor: COD-200R (40-tube capacity)",
      "Wavelength: 610 nm colorimetric detection",
      "Calibration: Pre-programmed standard curves",
      "Display: LCD with direct mg/L readout",
      "Connectivity: USB",
    ],
    applications: [
      "Municipal wastewater — COD effluent compliance monitoring",
      "Industrial effluent — COD discharge permit testing",
      "River and lake water quality monitoring",
      "Drinking water source protection monitoring",
      "Aquaculture water quality management",
      "Environmental laboratory routine COD analysis",
    ],
    specs: {
      "Method": "Dichromate closed reflux colorimetry",
      "Standard": "ISO 6060 / GB 11914",
      "COD Range": "5 to 3000 mg/L O₂",
      "Digestion Temperature": "165 °C",
      "Digestion Time": "30 minutes",
      "Reactor Capacity": "40 tubes",
      "Detection": "610 nm colorimetric",
      "Connectivity": "USB",
    },
    tags: ["COD", "chemical oxygen demand", "water quality", "wastewater", "colorimetric", "environmental"],
